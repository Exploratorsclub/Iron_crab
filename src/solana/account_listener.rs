...
impl AccountListener {
    ...
    pub fn new(
        ...
        // Massive buffer for high-volume trading (700k+ pools)
        // At 1000 events/sec, 50k buffer = 50 second tolerance before overflow
        let (tx, rx) = broadcast::channel(50000); // Buffer 50k events (was 10k)
