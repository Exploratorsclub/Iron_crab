...
fn quote_price_impact_monotonic() {
    let adapter = CfmAdapter { pools: vec![ CfmPool { pool:"P1".into(), base_mint:"BASE".into(), quote_mint:"QUOTE".into(), base_reserve: 1_000_000, quote_reserve: 2_000_000, fee_bps: 30, tick_spacing: None } ] };
