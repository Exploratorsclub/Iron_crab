...
**Zweck:** Explizite State Machines für Intent, Position und Execution. Verhindert Zustands-Chaos und falsche Annahmen über Lifecycle.

**Quellen:** `TARGET_ARCHITECTURE.md`, `MOMENTUM_V2_SPEC.md`, `DEFINITION_OF_DONE.md`, `src/ipc/schema.rs`
