...
5. Account-Index-Keys: 3 DEXes → **6 DEXes** (Meteora + Raydium CPMM)

**Erwartete Verbesserungen:**
- 📈 RPC Query Performance: +30-50%
- 📊 Account Query Throughput: +100%
- 🎯 DEX Coverage: 4 → 6 (Raydium AMM+CPMM, Orca, PumpFun, PumpSwap, Meteora DLMM)
...
--account-index-include-key Ase7...             # UNKNOWN (should be removed)
```
...
- ❌ Unknown account index key `Ase7z1mRLps2cTNQnRHpLyQL4Q5FHwonjmZnYCTuUDZM`
...
+ --account-index-include-key 6EF8rrecthR5Dkzon8Nwu78hRvfCKubJ14M5uBEwF6P \
...
- --account-index-include-key Ase7z1mRLps2cTNQnRHpLyQL4Q5FHwonjmZnYCTuUDZM
```

**New DEX Indexes:**
| Program ID | DEX | Type |
|------------|-----|------|
| `675kPX9MHTjS2zt1qfr1NYHuzeLXfQM9H24wFSUt1Mp8` | Raydium AMM V4 | AMM |
| `CPMMoo8L3F4NbTegBCKVNunggL7H1ZpdTHKxQB5qKP1C` | Raydium CPMM (**NEW**) | AMM |
| `whirLbMiicVdio4qvUfM5KAg6Ct8VwpYzGff3uctyCc` | Orca Whirlpool | CLMM |
| `6EF8rrecthR5Dkzon8Nwu78hRvfCKubJ14M5uBEwF6P` | PumpFun (**NEW**) | Bonding |
| `pAMMBay6oceH9fJKBRHGP5D4bD4sWpmSwMn52FMfXEA` | PumpSwap (**NEW**) | AMM |
| `LBUZKhRxPF3XUpBCjp4YzTKgLccjZhTSDM9YuVaPwxo` | Meteora DLMM (**NEW**) | DLMM |

**Removed:**
- `Ase7z1mRLps2cTNQnRHpLyQL4Q5FHwonjmZnYCTuUDZM` (unknown program, not needed)
...
| **DEX Account Indexes** | 3 | 6 | +100% DEX coverage |
